...
module.exports.loader = (data, option) => {
  switch (option) {
    case "warn":
      console.log(chalk.bold.hex(randomColor()).bold(" [ 𝐅𝐀𝐈𝐙-𝐏𝐑𝐎𝐉𝐄𝐂𝐓 ] ") + chalk.bold.hex("#8B8878").bold(data)+chalk.bold.hex("FF00DD")("\n✧➜  ✧ ✧ ✧ ✧ ✧ ✧ 𝐅𝐀𝐈𝐙-𝐏𝐑𝐎𝐉𝐄𝐂𝐓 𝐋𝐈𝐒𝐓 (👑)✧ ✧ ✧ ✧ ✧ ✧ ✧ ✧ ✧" ))
      break;
    case "error":
    console.log(chalk.bold.hex(randomColor()).bold(" [ 𝐅𝐀𝐈𝐙-𝐏𝐑𝐎𝐉𝐄𝐂𝐓 ] ") + data+chalk.bold.hex("5EFF00")("\n✧➜  ✧ ✧ ✧ ✧ ✧ ✧ 𝐅𝐀𝐈𝐙-𝐏𝐑𝐎𝐉𝐄𝐂𝐓 𝐋𝐈𝐒𝐓 (👑)✧ ✧ ✧ ✧ ✧ ✧ ✧ ✧ ✧" ));
      break;
    default:
